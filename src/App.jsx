...
const CARDS = [
  ...
  { id:15, type:'DUELLO', text:'Al countdown di 3, fate la faccia più brutta possibile. L\'avversario è il giudice supremo.', rule:'Il perdente beve. Se il giudice ride → beve anche lui/lei.' },
  ...
  { id:43, type:'DUELLO', text:'EQUILIBRIO: tieni una moneta piatta sul dorso della mano per 15 secondi.', rule:'Chi la fa cadere prima o non regge → beve.' },
  ...
  { id:38, type:'JOLLY', jollyType:'GRACE',  text:'✨ GRAZIA TOTALE: Annulla tutte le regole attive oppure salta questo turno senza bere nulla.', rule:'Scegli saggiamente.' },
  ...
  { id:41, type:'JOLLY', jollyType:'TRUTH',  text:'💬 CARTA VERITÀ: Fai all\'avversario UNA domanda qualsiasi. DEVE rispondere onestamente. Mente? → beve 2 sorsi.', rule:'Usa il potere con saggezza... o malizia.' },
]
